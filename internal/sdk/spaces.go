...
func (s *spaces) BatchQueryMessagingSubscriptionsForSpace(ctx context.Context, request operations.BatchQueryMessagingSubscriptionsForSpaceRequest) (*operations.BatchQueryMessagingSubscriptionsForSpaceResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "BatchQueryMessagingSubscriptionsForSpaceAlphaInput", "json")
	if err != nil {
...
func (s *spaces) ReplaceMessagingSubscriptionsInSpaces(ctx context.Context, request operations.ReplaceMessagingSubscriptionsInSpacesRequest) (*operations.ReplaceMessagingSubscriptionsInSpacesResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "ReplaceMessagingSubscriptionsInSpacesAlphaInput", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
