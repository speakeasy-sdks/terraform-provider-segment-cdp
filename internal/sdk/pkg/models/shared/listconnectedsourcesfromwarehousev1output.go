...
// ListConnectedSourcesFromWarehouseV1OutputPaginationOutput - Pagination metadata for a list response.
//
...
type ListConnectedSourcesFromWarehouseV1OutputPaginationOutput struct {
